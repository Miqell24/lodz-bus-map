...
export const RULES = { lowerAbbr: true,
  stops: {
    'Waltera-Janke-Waltera - Janke bl. 250(Pa': 'Waltera-Janke bl. 250 (Pabianice)',
    'Waltera-Janke-Waltera - Janke bl. 243(Pa': 'Waltera-Janke bl. 243 (Pabianice)',
  },
  stopRe: [[/\(Aleks\.$/, '(Aleksandrów'], [/\(ZOO Orien[a-z]*$/, '(ZOO Orientarium)']],
};
